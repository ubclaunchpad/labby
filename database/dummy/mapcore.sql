...
CALL save_question('MAPCORE-001','MAPCORE-FORM-1','MAPcore & GPEC Service Request Form','heading', 0, false);
CALL save_question('MAPCORE-002','MAPCORE-FORM-1','Request Type','multi', 1, true);
CALL save_question('MAPCORE-003','MAPCORE-FORM-1','Contact Details','contact', 2, true);
CALL save_question('MAPCORE-004','MAPCORE-FORM-1','Study Title','text', 3, true);
CALL save_question('MAPCORE-005','MAPCORE-FORM-1','Microtomy','heading', 4, false);
CALL save_question('MAPCORE-006','MAPCORE-FORM-1','Microtomy (FFPE Only)','multi', 5, false);
CALL save_question('MAPCORE-007','MAPCORE-FORM-1','Histochemistry','heading', 6, false);
CALL save_question('MAPCORE-008','MAPCORE-FORM-1','Routine Staining','multi', 7, false);
CALL save_question('MAPCORE-009','MAPCORE-FORM-1','Singleplex IHC','multi', 8, false);
CALL save_question('MAPCORE-010','MAPCORE-FORM-1','Multiplex IHC','multi', 9, false);
CALL save_question('MAPCORE-011','MAPCORE-FORM-1','In Situ Hybridization','multi', 10, false);
CALL save_question('MAPCORE-012','MAPCORE-FORM-1','NanoString GeoMx Digital Spacial Profiler','multi', 11, false);
CALL save_question('MAPCORE-013','MAPCORE-FORM-1','Imaging and Analysis','heading', 12, false);
CALL save_question('MAPCORE-014','MAPCORE-FORM-1','Slide Scanning','multi', 13, false);
CALL save_question('MAPCORE-015','MAPCORE-FORM-1','Scoring and Analysis','multi', 14, false);
CALL save_question('MAPCORE-016','MAPCORE-FORM-1','Tissue Type','multi', 15, false);
CALL save_question('MAPCORE-017','MAPCORE-FORM-1','Relevant Tissue Details','text', 16, false);
CALL save_question('MAPCORE-018','MAPCORE-FORM-1','Number of Blocks/Slides','text', 17, false);
CALL save_question('MAPCORE-019','MAPCORE-FORM-1','Coring Details','heading', 18, false);
CALL save_question('MAPCORE-020','MAPCORE-FORM-1','Cores Size','multi', 19, false);
CALL save_question('MAPCORE-021','MAPCORE-FORM-1','Number of Cores Per Block','multi', 20, false);
CALL save_question('MAPCORE-022','MAPCORE-FORM-1','Comments','text', 21, false);
CALL save_question('MAPCORE-023','MAPCORE-FORM-1','Detailed Service Request Form Template','download', 22, false);
CALL save_question('MAPCORE-024','MAPCORE-FORM-1','Relevant File Upload','upload', 23, false);
