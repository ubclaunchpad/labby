...
import { FILTER_BILLABLE, LOAD_BILLABLE, SET_BILLABLE, SET_OG_BILLABLE, LOAD_BILLABLE_BY_SOWID, SET_BILLABLE_BY_SOWID, UPDATE_CLICKS, BILL_BILLABLE, GET_CLICKS } from "../actions/billingActions";
import { billBillable, getBillable, getBillableByFilter, getBillableBySOWID, getClick, saveClick } from "../api/billingApi";
...
export function* getClickSaga({ payload }) {
  const clicks = yield call(getClick, payload);
  return clicks;
}
...
export default function* billingSaga() {
  ...
  yield takeLatest(GET_CLICKS, getClickSaga);
